...
Q_W1 = tf.Variable(xavier_init([X_dim + y_dim, h_dim]),name="Q_W1")
...
print(X_dim,y_dim,Q_W1,Q_W2_mu,P_W1,P_W2)
...
for it in range(1000000):
    ...
    if it % 1000 == 0:
        ...
        i += 1
    if it %1000==0:
        saver.save(sess,"model_result/mnist_cvae",global_step=it)
plt.close(fig)